 ...
 */
@Service
public class UsuarioCreacionServiceImpl
        implements UsuarioCreacionService {
    ...
    public UsuarioCreacionServiceImpl(
    ...
    private void validarEspecialidad(
        ...
        /*
         * La obligatoriedad ya la valida
         * UsuarioFormularioValidator.
         */
    ...
    private Map<String, Object> crearSnapshot(
        ...
        /*
         * No incluimos contraseña, DPI ni NIT
         * ni sus hashes/cifrados.
         */
